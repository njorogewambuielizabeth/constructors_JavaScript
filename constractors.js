...
class Rental {
    ...
    calculateRentalDuration() {
      const duration = (this.rentalEndDate - this.rentalStartDate) / (1000 * 60 * 60 * 24);
      return Math.round(duration);
    }
  }
  const myRental = new Rental(myCar, "Aurora Wambui", new Date("2023-05-01"), new Date("2023-05-05"));

console.log(myRental.calculateRentalDuration()); 
...
const car1 = new Car('BMW', 'X7', 2020, true);


const rental1 = new Rental(car1, 'Fiddel Shakes', new Date('2023-04-21'), new Date('2023-05-05'));
